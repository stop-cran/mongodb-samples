...
namespace WebApplication1.Repositories
{
    ...
    {
        private readonly IMongoCollection<WeatherDto> weatherDtoCollection;
        
        public  MongoDbWeatherRepository(IMongoCollection<WeatherDto> weatherDtoCollection)
        {
            this.weatherDtoCollection = weatherDtoCollection;
        }
        ...
        public async Task<List<WeatherDto>> GetByLocation(
            ...
            await weatherDtoCollection.Find(l => l.Location == location,
                    new FindOptions
                    {
